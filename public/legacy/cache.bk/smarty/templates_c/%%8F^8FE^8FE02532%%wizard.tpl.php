<?php /* Smarty version 2.6.33, created on 2022-03-27 14:53:48
         compiled from modules/Users/tpls/wizard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Users/tpls/wizard.tpl', 68, false),array('function', 'sugar_help', 'modules/Users/tpls/wizard.tpl', 178, false),array('function', 'html_options', 'modules/Users/tpls/wizard.tpl', 179, false),)), $this); ?>
...
<div id="welcome" class="screen welcome" style="background-image: url('include/images/initial_page_bg.svg');">
    <div class="container-fluid">
        <div class="row">
            <div class="col panel">
                <h1><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_WELCOME_TITLE']; ?>
</h1>
                ...
                <div class="wizard-lbl"><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_WELCOME_NOSMTP']; ?>
</div>
...
<div id="personalinfo" class="screen personal">
    <div class="container-personal">
        <h2 class="header-title">
            <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_PERSONALINFO']; ?>

        </h2>
        <div class="row">
            <div class="col mobile-order">
                <div class="left-side"><?php echo $this->_tpl_vars['MOD']['LBL_FIRST_NAME']; ?>
:</div>
                <div><input id='first_name' name='first_name' tabindex='1' size='25' maxlength='25' type="text" value="<?php echo $this->_tpl_vars['FIRST_NAME']; ?>
"></div>
            </div>
            <div class="col">
                <div class="left-side"><?php echo $this->_tpl_vars['MOD']['LBL_ADDRESS_STREET']; ?>
:</div>
                <div><input name='address_street' tabindex='8' value="<?php echo $this->_tpl_vars['ADDRESS_STREET']; ?>
"/></div>
            </div>
            <div class="col mobile-order">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_LAST_NAME']; ?>
: <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></span></div>
                <div><span><input id='last_name' name='last_name' tabindex='2' size='25' maxlength='25' type="text" value="<?php echo $this->_tpl_vars['LAST_NAME']; ?>
"></span></div>
            </div>
            <div class="col">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_CITY']; ?>
:</span></div>
               <div><span><input name='address_city' tabindex='8' size='15' maxlength='100' value='<?php echo $this->_tpl_vars['ADDRESS_CITY']; ?>
'></span></div>
            </div>
            <div class="col mobile-order">
                <div class="left-side"><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL']; ?>
: <?php if ($this->_tpl_vars['REQUIRED_EMAIL_ADDRESS']): ?><span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span><?php endif; ?></div>
                <div><span><input name='email1' tabindex='3' size='30' maxlength='100' value='<?php echo $this->_tpl_vars['EMAIL1']; ?>
' id='email1' /></span></div>
            </div>
            <div class="col">
                <div class="left-side"> <span><?php echo $this->_tpl_vars['MOD']['LBL_POSTAL_CODE']; ?>
:</span></div>
                <div><span><input name='address_postalcode' tabindex='9' size='10' maxlength='20' value='<?php echo $this->_tpl_vars['ADDRESS_POSTALCODE']; ?>
'></span></div>
            </div>
            <div class="col mobile-order">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_OFFICE_PHONE']; ?>
:</span></div>
                <div><span><input name='phone_work' type="text" tabindex='4' size='20' maxlength='25' value='<?php echo $this->_tpl_vars['PHONE_WORK']; ?>
'></span></div>
            </div>
            <div class="col">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_STATE']; ?>
:</span></div>
                <div><span><input name='address_state' tabindex='9' size='15' maxlength='100' value='<?php echo $this->_tpl_vars['ADDRESS_STATE']; ?>
'></span></div>
            </div>
            <div class="col mobile-order">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_MOBILE_PHONE']; ?>
:</span></div>
                <div><span><input name='phone_mobile' type="text" tabindex='6' size='20' maxlength='25' value='<?php echo $this->_tpl_vars['PHONE_MOBILE']; ?>
'></span></div>
            </div>
            <div class="col">
                <div class="left-side"><span><?php echo $this->_tpl_vars['MOD']['LBL_COUNTRY']; ?>
:</span></div>
                <div><span><input name='address_country' tabindex='10' size='10' maxlength='20' value='<?php echo $this->_tpl_vars['ADDRESS_COUNTRY']; ?>
'></span></div>
            </div>            
        </div>
    </div>
            ...
            <td>
                <div class="edit view">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="left" scope="row" colspan="4" class="firstrow"><i><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_LOCALE_DESC']; ?>
</i></td>
                        </tr>
                        <tr>
                            <td scope="row" nowrap="nowrap" style="line-height:4.3em;margin-top:0.5em;"><span><?php echo $this->_tpl_vars['MOD']['LBL_TIMEZONE']; ?>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="user-icon">
                        ...
                        <tr>
                            <td scope="row" style="height: auto;">
                                <h3 class="wizard-finish-lbl"><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH1']; ?>
</h3>
                                <table cellpadding=0 cellspacing=0><input id='whatnext' name='whatnext' type="hidden" value='finish' />
                                    <?php if ($this->_tpl_vars['IS_ADMIN']): ?>
                                        <tr><td><img src=include/images/icon_start_using.svg style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="finish";document.UserWizard.submit()' href="#" ><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH2']; ?>
  </b></a> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH2DESC']; ?>
</div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_import_data.svg style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="import";document.UserWizard.submit()' href="#" ><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH3']; ?>
 </b></a>  <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH4']; ?>
 </div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_create_users.svg style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="users";document.UserWizard.submit()' href="#"  ><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH5']; ?>
 </b></a> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH6']; ?>
 </div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_view_and_manage.svg style="margin-right: 5px;"></td><td><a  onclick='document.UserWizard.whatnext.value="settings";document.UserWizard.submit()' href="#" ><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH7']; ?>
 </b></a> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH8']; ?>
 </div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_configure.svg style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="studio";document.UserWizard.submit()' href="#"  ><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH9']; ?>
 </b></a> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH10']; ?>
 </div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_visit_site.svg style="margin-right: 5px;"></td><td><a href="https://community.suitecrm.com" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
 </div> </td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                    <?php else: ?>
                                        <tr><td><img src=include/images/icon_visit_site.svg style="margin-right: 5px;"></td><td><a href="https://suitecrm.com" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH11']; ?>
 </b></a></b> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH12']; ?>
</div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_documentation.svg style="margin-right: 5px;"></td><td><a href="https://docs.suitecrm.com/user/" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH14']; ?>
 </b></a></b> <div class="img-desc"> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH15']; ?>
</div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/icon_forums.svg style="margin-right: 5px;"></td><td><a href="https://community.suitecrm.com/" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH18']; ?>
 </b></a></b> <div class="img-desc"><?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH19']; ?>
</div></td></tr>
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                    <?php endif; ?>
                                </table>
